...
Tcl_ChannelType consoleOutputChannelType =
{
	(char*)"console1", /* const char* typeName*/
        (Tcl_ChannelTypeVersion)TCL_CHANNEL_VERSION_5, /*Tcl_ChannelTypeVersion version*/
        NULL, //(closeProcedureForBothTcl_ChannelType) /*NULL*/, /*Tcl_DriverCloseProc* closeProc*/
	...
	NULL, /*Tcl_DriverGetOptionProc* getOptionProc*/
        DriverWatchProc, /*Tcl_DriverWatchProc* watchProc*/
	NULL, /*Tcl_DriverGetHandleProc* getHandleProc*/
        DriverClose2Proc, /*Tcl_DriverClose2Proc* close2Proc*/
